...
/**
 * TrackEditCard
 * Form card for editing an individual track within an existing project.
 */
  ...
  return (
    ...
    >
      <CardContent sx={{ p: { xs: 2, sm: 2.5 } }}>
        {/* Header Bar: Track index badge and actions */}
        <Box
          sx={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            {onCopyTrack && (
              <Tooltip title='Copy to Another Project' arrow>
                <IconButton
                  size='small'
                  onClick={() => onCopyTrack(track, index)}
