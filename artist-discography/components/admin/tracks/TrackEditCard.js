          ...
          <Grid size={{ xs: 12 }}>
            ...
            >
              ...
              >
                ...
                >
                  {track.audioFile || track.audioUrl || track.audio ? 'Replace Audio File' : 'Upload Audio File'}
                  <input
                    type="file"
                    accept="audio/*"
                    hidden
                ...
                >
                  {track.audioFile ? (
                    ...
                    <>
                      ...
                      >
                        <strong>Transcoded Tiers:</strong> data/cache/audio/ (*.flac lossless, *.mp3 stream)
                      </Typography>
                      <Typography
                        variant="caption"
                        sx={{
                      ...
                      >
                        <strong>Stream Endpoint:</strong> /api/audio/projects/{projectSlug}/{track.audioUrl || track.audio}
                      </Typography>
                    </>
                  ) : (
                    <Typography
